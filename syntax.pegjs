...
NullLiteral
  = NullToken { console.log("null"); return { type: "NullLiteral" }; }

BooleanLiteral
  = TrueToken  { console.log("true"); return { type: "BooleanLiteral", value: true  }; }
  / FalseToken { console.log("false"); return { type: "BooleanLiteral", value: false }; }

NumericLiteral "number"
  = literal:(HexIntegerLiteral / DecimalLiteral) !IdentifierStart {
      console.log("NumericLiteral : " + literal);
      return literal;
    }

DecimalLiteral
  = parts:(DecimalIntegerLiteral "." DecimalDigits? ExponentPart?) {
      console.log("DecimalLiteral : " + parts.join(''));
      return parseFloat(parts.join(''));
    }
  / parts:("." DecimalDigits ExponentPart?)     { console.log("DecimalLiteral : " + parts.join('')); return parseFloat(parts.join('')); }
  / parts:(DecimalIntegerLiteral ExponentPart?) { console.log("DecimalLiteral : " + parts.join('')); return parseFloat(parts.join('')); }
...
UsingStatement 
  = UsingKeyword __ name:NamespaceName (__ "=" __ aliasName:AliasName)?
...
NamespaceDeclaration 
  = NamespaceKeyword __ name:NamespaceName __ block:NamespaceBlock {
...
ClassDeclaration 
  = ClassKeyword __ name:Identifier __ block:ClassBlock {
...
StructDeclaration 
  = StructKeyword __ name:Identifier __ block:StructBlock {
...
EnumDeclaration 
  = EnumKeyword __ name:Identifier __ block:EnumBlock {
...
EnumBody
  = elements:(Identifier __ "=" __ Initialization __ ";")+ {
      for (var i = 0; i < elements.length; i++) {
        console.log("enum " + elements[i][0] + ":" + elements[i][4]);
      }
    }

ObjectDeclaration 
  = ObjectKeyword __ name:Identifier __ block:ObjectBlock {
...
FunctionDeclaration
  = DefKeyword __ name:Identifier __ "(" __ Arguments __ ")" (":" __ returnVal:ReturnType)? __ DefBody {
      console.log("Function Name : " + name);
    }

Arguments 
  = __
  / head:Argument __ tail:("," __ Argument)* 

Argument
  = name:Identifier type:(":" __ Type)? {
      console.log("Argument : " + name + "=" + type[2]);
    }
...
Type
  = BaseType ("[" __ Literal __ "]")* 

BaseType
  = name:Identifier templateArgs:("<" TemplateArgs ">")? {
      console.log("BaseType : " + name);
    }
  / "char"
  / "short"
  / "int"
...
TemplateArgs 
  = __
  / head:BaseType __ tail:("," __ BaseType)* 
  
DefBody 
  = "=" __ Expression
  / "{" __ ( FunctionDeclaration / VariableDeclaration / ValueDeclaration / Expressions )* __ "}" 

VariableDeclaration
  = DefVariableKeyword __ name:Identifier type:(":" Type)? __ initial:("=" __ ValueInitialization)?

ValueDeclaration
  = DefValueKeyword __ name:Identifier type:(":" Type)? __ "=" __ initial:ValueInitialization ";"
...
Expression
  ...
  / ReturnExpression
  / BlockExpression
  / SimpleExpression __ PrimaryExpression?

PrimaryExpression
  = operator:BinaryOperator __ right:SimpleExpression {
      console.log("Binary Expression : " + operator + " " + right);
    }
  / "(" __ args:CallArguments __ ")" {
      console.log("Function Call : ");
    }
  / operator:AssignmentOperator __ right:SimpleExpression {
      console.log("Assignment Expression : " + operator + " " + right);
    }
  / __

ForStatement
  = ForKeyword __ ForConditionStatement __ ForBody

// 아직 미정
ForConditionStatement 
  = "(" __ name:Identifier __ "<=" __ ForSource __ ")" {
      console.log("For Condition : " + name);
    }

// 아직 미정
ForSource 
  = "[" __ head:SimpleExpression __ "..." __ tail:SimpleExpression __ "]" {
      console.log("For Source : " + head + " to " + tail);
    }
...
IfStatement
  = IfKeyword IfConditionStatement __ IfBody __ (ElseKeyword __ ElseBody)?
...
ReturnExpression
  = ReturnKeyword __ expr:SimpleExpression? {
      console.log("Return Expression");
    }

CallElement
  = name:Identifier __ "=" __ value:SimpleExpression {
      console.log("Call Element : " + name + " = " + value);
    }

CallArguments
  = __
  / head:SimpleExpression __ tail:("," __ SimpleExpression)*
  / CallElement __ tail:("," __ CallElement)*
  / CallElement __ middle:("," __ CallElement)* __ tail:("," __ SimpleExpression)*
...
Attribute
  = "[@" name:NamespaceName ( __ args:CallArguments __ )? "]" {
